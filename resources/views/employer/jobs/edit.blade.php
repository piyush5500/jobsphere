<x-app-layout>
    <div class="form-container">
        ...
        <div class="form-header">
            ...
            <p class="page-subtitle">Update the job posting details</p>
        </div>
                ...
                <div class="job-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" id="title" class="form-input @error('title') border-red-500 @enderror" 
                            placeholder="e.g. Senior Software Engineer, Marketing Manager, UX Designer" value="{{ old('title', $job->title) }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="description" rows="8" class="form-input @error('description') border-red-500 @enderror" 
                            placeholder="Describe the job responsibilities, requirements, qualifications, and benefits..." required>{{ old('description', $job->description) }}</textarea>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="location" id="location" class="form-input @error('location') border-red-500 @enderror" 
                                placeholder="e.g. New York, NY or Remote" value="{{ old('location', $job->location) }}" required>
                            @error('location')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="salary" id="salary" class="form-input @error('salary') border-red-500 @enderror" 
                                placeholder="e.g. $80,000 - $120,000 per year" value="{{ old('salary', $job->salary) }}">
                ...
                <div class="job-section">
                    ...
                    <div class="form-group">
                        ...
                        <select name="is_active" id="is_active" class="form-input">
                            <option value="1" {{ old('is_active', $job->is_active) == '1' || old('is_active', $job->is_active) == true ? 'selected' : '' }}>Active - Accepting Applications</option>
                            <option value="0" {{ old('is_active', $job->is_active) == '0' || old('is_active', $job->is_active) == false ? 'selected' : '' }}>Inactive - Not Accepting Applications</option>
                        </select>
